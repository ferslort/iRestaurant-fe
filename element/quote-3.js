      ...
      <div className="content-inner">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xl-6 m-b30 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
              <div className="dlab-media">
                <img src="images/about/img3.png" className="move-3" alt="" />
              </div>
            </div>
            <div className="col-xl-6 m-b30 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.4s">
              <form className="dlab-form dzForm" method="POST" action="script/contact.php">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="input-group">
                      <select name="dzOther[priority]" className="form-control" required defaultValue={'Priority'}>
                  ...
                  <ReCAPTCHA sitekey="6LefsVUUAAAAADBPsLZzsNnETChealv6PYGzv3ZN" onChange={onChange} />
                  <div className="col-sm-12 m-2">
                    <button name="submit" type="submit" value="Submit" className="btn btn-corner gradient btn-primary">
                      Submit Now
                    </button>
                  </div>
                </div>
